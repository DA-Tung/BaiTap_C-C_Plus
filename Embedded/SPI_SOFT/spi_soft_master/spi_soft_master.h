...
// Define macro PIN
#define SS_DISENABLE				gpio_output(GPIOA,PORTA,Master_SS,PIN_SET)			// Set SS Pin of Master
#define SS_ENABLE					gpio_output(GPIOA,PORTA,Master_SS,PIN_RESET)		// Reset SS Pin of Master
#define SCK_SET						gpio_output(GPIOA,PORTA,Master_SCK,PIN_SET)			// Set SCK Pin of Master
#define SCK_RST						gpio_output(GPIOA,PORTA,Master_SCK,PIN_RESET)		// Reset SCK Pin of Master
#define MOSI_SET					gpio_output(GPIOA,PORTA,Master_MOSI,PIN_SET)		// Set MOSI Pin of Master
#define MOSI_RST					gpio_output(GPIOA,PORTA,Master_MOSI,PIN_RESET)		// Reset MOSI Pin of Master		
#define MISO_PIN					gpio_input(GPIOA,PORTA,Master_MISO)					// MISO Pin INPUT
